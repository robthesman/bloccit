  ...
  let(:my_post) { create(:post, topic: my_topic, user: my_user) }
   ...
   context "unauthenticated user" do
     it "POST create returns http unauthenticated" do
       post :create, post: {title: "Post Name", body: "Post Description", topic_id: my_topic.id, user_id: my_user.id}
   ...
   context "unauthorized user" do
     ...
     it "PUT update returns http forbidden" do
       put :update, id: my_post.id, topic_id: my_topic.id, post: {title: "Post Name", body: "Post Description"}
   ...
   context "authenticated and authorized users" do
     ...
     describe "POST create" do
       before { post :create, user_id: my_user.id, topic_id: my_topic.id, post: {title: @new_post.title, body: @new_post.body} }
